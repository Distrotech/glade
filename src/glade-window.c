...
glade_window_class_init (GladeWindowClass *klass)
{
  ...
  /* Internal children */
  gtk_widget_class_bind_template_child_internal_private (widget_class, GladeWindow, project_list_actiongroup);
  ...
  gtk_widget_class_bind_template_child_internal_private (widget_class, GladeWindow, pointer_mode_actiongroup);
  ...
  gtk_widget_class_bind_template_child_internal_private (widget_class, GladeWindow, icons_and_labels_radioaction);
  gtk_widget_class_bind_template_child_internal_private (widget_class, GladeWindow, toolbar_visible_action);
  gtk_widget_class_bind_template_child_internal_private (widget_class, GladeWindow, project_tabs_visible_action);
  gtk_widget_class_bind_template_child_internal_private (widget_class, GladeWindow, statusbar_visible_action);
  gtk_widget_class_bind_template_child_internal_private (widget_class, GladeWindow, editor_header_visible_action);
